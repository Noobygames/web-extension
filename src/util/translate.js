...
const translation = Object.freeze({
  ...
  text: {
    ...
    28: {
      de: "Verbleibende Ressourcen",
      en: "Resources to keep",
      es: "Recursos a permanecer",
      fr: "Ressources restantes",
      tr: "Saklanacak kaynaklar",
      br: "Recursos para manter",
    },
    29: {
      de: "Verbleibende Schiffe",
      en: "Ships to keep",
      es: "Naves a permanecer",
      fr: "Navires restants",
      tr: "Saklanacak gemiler",
      br: "Naves para manter",
    },
    30: {
    ...
    215: {
      de: "Sichtbar mit Weiterleitung",
      en: "Visible with redirection",
      es: "Visible con redirección",
      fr: "Visible avec redirection",
      tr: "Yeniden yönlendirme ile görünür",
      br: "Visível com redirecionamento",
    },
    216: {
    ...
    218: {
      de: "Lebensform-Konstruktionen",
      en: "Lifeform constructions",
      es: "Construcciones de formas de vida",
      fr: "Constructions de formes de vie",
      tr: "Yaşam formu inşaatları",
      br: "Construções de formas de vida",
    },
    219: {
      de: "Lebensform-Forschung",
      en: "Lifeform research",
      es: "Investigación de formas de vida",
      fr: "Recherches des formes de vie",
      tr: "Yaşam formu araştırmaları",
      br: "Pesquisas de formas de vida",
    },
    220: {
      de: "Eigener Flottenausbeutewert",
      en: "Own fleet yield value",
      es: "Valor de rendimiento de la flota",
      fr: "Valeur de rendement de la flotte",
      tr: "Kendi filonuzun verim değeri",
      br: "Valor de rendimento da própria frota",
    },
    221: {
      de: "Symbole",
      en: "Icons",
    ...
    238: {
      de: "Ungenutzte Kapazität",
      en: "Wasted capacity",
      es: "Capacidad desperdiciada",
      fr: "Capacité gaspillée",
      tr: "Boşa giden kapasite",
      br: "Capacidade desperdiçada",
    },
    239: {
      de: "Nichts zu sammeln",
      en: "Nothing to harvest",
      es: "Nada que recolectar",
      fr: "Rien à collecter",
    ...
    248: {
      de: "Klassen & Offiziere",
      en: "Class & officers",
      es: "Clase y oficiales",
      fr: "Classe et officiers",
    ...
    251: {
      de: "Breites Layout (ab 1600px)",
      en: "Wide layout (from 1600px)",
      es: "Diseño ancho (desde 1600px)",
      fr: "Mise en page large (à partir de 1600px)",
      tr: "Geniş yerleşim (1600px'den itibaren)",
      br: "Layout largo (a partir de 1600px)",
    },
    252: {
      de: "Inhalt vergrößern (Zoom)",
      en: "Scale content (zoom)",
      es: "Ampliar contenido (zoom)",
      fr: "Agrandir le contenu (zoom)",
      tr: "İçeriği büyüt (yakınlaştırma)",
      br: "Ampliar conteúdo (zoom)",
    },
    253: {
      de: "Zoomfaktor",
      en: "Zoom factor",
      es: "Factor de zoom",
      fr: "Facteur de zoom",
      tr: "Yakınlaştırma çarpanı",
      br: "Fator de zoom",
    },
    254: {
      de: "0 = automatisch (1.15 / 1.25 / 1.4 je nach Breite). Ein eigener Wert zwischen 1 und 1.75 gilt ab 1600px sofort.",
      en: "0 = automatic (1.15 / 1.25 / 1.4 by viewport width). A custom value between 1 and 1.75 applies from 1600px up.",
      es: "0 = automático (1.15 / 1.25 / 1.4 según el ancho). Un valor propio entre 1 y 1.75 se aplica desde 1600px.",
      fr: "0 = automatique (1.15 / 1.25 / 1.4 selon la largeur). Une valeur personnalisée entre 1 et 1.75 s'applique dès 1600px.",
      tr: "0 = otomatik (genişliğe göre 1.15 / 1.25 / 1.4). 1 ile 1.75 arasında kendi değeriniz 1600px'den itibaren geçerlidir.",
      br: "0 = automático (1.15 / 1.25 / 1.4 conforme a largura). Um valor próprio entre 1 e 1.75 vale a partir de 1600px.",
    },
    255: {
    ...
    257: {
      de: "Flotte zum Planeten",
      en: "Fleet to planet",
      es: "Flota al planeta",
      fr: "Flotte vers la planète",
      tr: "Gezegene filo",
      br: "Frota para o planeta",
    },
    258: {
      de: "Flotte zum Mond",
      en: "Fleet to moon",
      es: "Flota a la luna",
      fr: "Flotte vers la lune",
      tr: "Aya filo",
      br: "Frota para a lua",
    },
    259: {
      de: "Spionage nur über die Galaxieansicht (Gameforge-Regeln)",
      en: "Spying only via the galaxy view (Gameforge rules)",
      es: "Espionaje solo desde la vista de galaxia (reglas de Gameforge)",
      fr: "Espionnage uniquement via la vue galaxie (règles Gameforge)",
      tr: "Casusluk yalnızca galaksi görünümünden (Gameforge kuralları)",
      br: "Espionagem apenas pela vista da galáxia (regras da Gameforge)",
    },
  },
});
