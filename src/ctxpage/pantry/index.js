...
async function pantrySync(context, pantryKey, mainSyncObj, action = "merge") {
  ...
  if (action === "post") {
    ...
    mainSyncJsonObj.options = OGBIData.json?.options;
    mainSyncJsonObj.searchHistory = OGBIData.json?.searchHistory;
    mainSyncJsonObj.search = OGBIData.json?.search;
    mainSyncJsonObj.sideStalk = OGBIData.json?.sideStalk;
    mainSyncJsonObj.myActivities = OGBIData.json?.myActivities;
    mainSyncJsonObj.needs = OGBIData.json?.needs;
    mainSyncJsonObj.playerMarkers = OGBIData.json?.playerMarkers;
    mainSyncJsonObj.markers = OGBIData.json?.markers;
    mainSyncJsonObj.sideStargetTabstalk = OGBIData.json?.targetTabs;
    mainSyncJsonObj.missing = OGBIData.json?.missing;
    mainSyncJsonObj.flying = OGBIData.json?.flying;
    mainSyncJsonObj.productionProgress = OGBIData.json?.productionProgress;
    mainSyncJsonObj.lfProductionProgress = OGBIData.json?.lfProductionProgress;
    mainSyncJsonObj.researchProgress = OGBIData.json?.researchProgress;
    mainSyncJsonObj.lfResearchProgress = OGBIData.json?.lfResearchProgress;
    mainSyncJsonObj.reminders = OGBIData.json?.reminders;

    mainSyncJsonObj.expeditions = await getObjLastElements(context, OGBIData.json?.expeditions, 5000);
    mainSyncJsonObj.expeditionSums = OGBIData.json?.expeditionSums;
    mainSyncJsonObj.combats = await getObjLastElements(context, OGBIData.json?.combats, 5000);
    mainSyncJsonObj.combatsSums = OGBIData.json?.combatsSums;
    mainSyncJsonObj.discoveries = await getObjLastElements(context, OGBIData.json?.discoveries, 5000);
    mainSyncJsonObj.discoveriesSums = OGBIData.json?.discoveriesSums;
    mainSyncJsonObj.harvests = OGBIData.json?.harvests;
    mainSyncJsonObj.spies = await getObjLastElements(context, OGBIData.json?.spies, 5000);
    mainSyncJsonObj.notifications = OGBIData.json?.notifications;
